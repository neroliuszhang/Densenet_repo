...
tf.app.flags.DEFINE_integer("TRAINING_SET_SIZE", 454, "total image number of training set")
tf.app.flags.DEFINE_integer("TESTING_SET_SIZE", 454, "total image number of training set")
